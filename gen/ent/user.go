...
func (e UserEdges) AudioOrErr() ([]*Audio, error) {
	if e.loadedTypes[0] {
		return e.Audio, nil
	}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldLogin, user.FieldPassword:
...
func (u *User) QueryAudio() *AudioQuery {
	return NewUserClient(u.config).QueryAudio(u)
}
